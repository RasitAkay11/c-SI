...
public:
    ...
    void decreaseHealth();
    void increaseHealth();
    unsigned __int8 getHealth() {return health;}; //19. useful getter. 44. correct useage of inline function
private:
    unsigned __int8 health; //18. useful member variabel. 27. Best suited type everywhere(0 to 255)
};
}
